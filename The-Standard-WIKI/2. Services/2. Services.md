...
Services have several types based on where they stand in any given architecture. They fall under three main categories, which are:
validators, orchestrators and aggregators.
